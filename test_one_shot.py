...
def test(args):
    ...
    ckpt = os.path.join(ckpt_dir, "checkpoints_epoch_{}.pth".format(test_ckpt_epoch))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_dir', type=str, default='experiments/train_oneshot_seg_few_model-er-train_oneshot_support_for_mito_compare.txt-2021616_1250')
    parser.add_argument('--support_list', type=str, default='mito_widefield/test_oneshot_support.txt')
    parser.add_argument('--query_list', type=str, default='mito_widefield/test.txt')
    parser.add_argument('--test_ckpt_epoch', type=int, default=30)

    parser.add_argument('--network', type=str, default='one_model')
